    ...
    <div class="container-fluid fixed-top rounded p-1"  style = "background-color : #{{$site->color_head}}";>
        <div class="row "  >
         ...
         <div class="col-sm-5 d-flex justify-content-center ps-lg-5">
          <h4 class=" text-white ps-lg-5"> <a class=" text-white ps-lg-5" href="tel:{{$site->phone_1}}" rel="nofollow"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 16 16">
